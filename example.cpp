...
int main(){
	Netsh a;
	a.create(Models::Input, Activation::Linear, std::vector<int>{0,1}, std::vector<int>{2});
	a.create(Models::FullyConnected, Activation::Tanh, std::vector<int>{0,1}, std::vector<int>{10});
